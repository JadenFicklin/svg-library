  ...
  return (
    <>
      <div
        ...
        className={c(
          `relative m-3 w-full h-14 bg-white rounded-md gray-shadow max-w-[400px]`
        )}>
        <div
          className={c(
        ...
        {filteredSvgs.map((svg, index) => (
          <div
            ...
            className={c(
              ...
              initialColor === '#ffffff' ? ' bg-zinc-900' : 'bg-white'
            )}
            style={{
            ...
            <div className="mx-auto mt-2 w-min duration-300">
